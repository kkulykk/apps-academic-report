     ...
     <section className={styles.section}>
       <div className={styles.wrapper}> 
        ...
        {open1? 
          ...
          інтелекту у м.Львові ініційовану <a className={styles.link} href="https://apps.ucu.edu.ua/oleksii-molchanovskyi/">Олексієм Молчановським</a>.<br/>
          ...
          розвивати в трьох сферах: економіки, освіти та міського управління.<br/>
      ...
      <div className={styles.wrapper}>
       ...
       {open2? <p className={styles.description}>
         ...
         самостійно викладають навчальні курси для учасників школи.<br/>
      ...
      <div className={styles.wrapper}>
       ...
       <p className={styles.description}>
         ...
         великим українським бізнесом проводить Business Tech Challenge.<br/>
         ...
         позмагатися разом з своєю командою за Приз від компанії.<br/>
         ...
         перемогу та приз 30 000 грн.<br/>
      ...
      <div className={styles.wrapper}>
       ...
       <p className={styles.description}>
         ...
         у сфері Data Science до загальної кількості вакансій в IT.<br/>
     ...
     <div className={styles.wrapper}>
      ...
      <div className={styles.wrapper}>
       ...
       <p className={styles.description}>
         ...
         студентка факультету прикладних наук Софія Гаркот.<br/>
      ...
      <div className={styles.wrapper}>
       ...
       {open7? 
       <p className={styles.description}>
         Важливим вектором розвитку факультету прикладних наук УКУ є організація 
         курсів та проектів, які мають суспільно-орієнтовану специфіку. На 
         магістерській програмі з Наук про дані на постійній основі відбувається 
         навчальний курс “Data Science in real life”. В рамках цього курсу 
         студенти-магістри працюють над практичними кейсами, які мають суспільну 
         важливість.<br/>
         Весною 2021 р. студенти розпочали два проекти у співпраці з Львівською 
         міською радою, які стосувулися аналізу даних щодо середніх шкіл Львова, 
         а також системи громадського транспорту міста.<br/> 
         У першому проекті студенти працювали з даними щодо аналізу успішності 
         середніх шкіл за результатами ЗНО. Крім того вони аналізували дані щодо 
