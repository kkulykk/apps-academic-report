  ...
  <>
    ...
    <Container>
      <section className={styles.section}>
        ...
        <div className={styles.chartWrapper}>
         ...
         Наші бакалаврські програми ‘’Комп’ютерні науки’’, ‘’ІТ та бізнес-аналітика’’, 
          ...
          інформаційних технологій, а наші випускники – не просто успішні працівники 
          всесвітньовідомих ІТ компаній, вони є лідерами, що готові творити нові продукти 
          і послуги, нові ідеї та нові сенси як у галузі інформаційних технологій, так і 
          в інших сферах людського життя.<br/>
      ...
      <ul className={styles.list}>
        ...
        <li className={styles.item}>
        <div className={styles.imgWrapper}>
         <img className={styles.listIcon} src={img3}   alt="people"/></div>
         <p className={styles.descrptn}>відкриття магістерської програми з Наук про дані УКУ</p>
         <p className={styles.year}>2016</p>      
        </li>

        <li className={styles.item}>
         <div className={styles.imgWrapper}><img className={styles.listIcon}  src={img4}  alt="note" /></div>
         <p className={styles.descrptn}>відкриття бакалаврської програми з IT та бізнес-аналітики</p>
         <p className={styles.year}>2017</p>
        </li>

        <li className={styles.item}>
         <div className={styles.imgWrapper}><img className={styles.listIcon} src={img5}   alt="vector buisness-analitics" /></div>
         <p className={styles.descrptn}>стратегічне партнерство з Eleks</p>
         <p className={styles.year}>2017</p>
        </li>

        <li className={styles.item}>
         <div className={styles.imgWrapper}><img className={styles.listIcon}  src={img6} alt="eleks logo" /></div>
         <p className={styles.descrptn}>відкриття Лабораторії машинного навчання УКУ</p>
         <p className={styles.year}>2018</p>
        </li>
      
      <li className={styles.item}>
         <div className={styles.imgWrapper}><img className={styles.listIcon}  src={img7} alt="SoftServe logo" /></div>
         <p className={styles.descrptn}>стратегічне партнерство з SoftServe</p>
         <p className={styles.year}>2019</p>
        </li>

        <li className={styles.item}>
         <div className={styles.imgWrapper}><img className={styles.listIcon}  src={img8} alt="Facebook logo" /></div>
         <p className={styles.descrptn}>стратегічне партнерство з Facebook</p>
         <p className={styles.year}>2020</p>
        </li>

        <li className={styles.item}>
         <div className={styles.imgWrapper}><img className={styles.listIcon}  src={img9} alt="data engeneering" /></div>
