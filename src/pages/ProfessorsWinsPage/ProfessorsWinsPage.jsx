...
const ProfessorsWinsPage = () => {
 ...
 <p className={styles.description}>
   ...
   свою нагороду Олесь Добосевич.<br/>
   <a href="https://ucu.edu.ua/news/chetvero-vykladachiv-uku-staly-laureatamy-rektorskoyi-premiyi-2021-za-naukovi-doslidzhennya/" className={styles.link}>Детальніше</a>
     ...
     <div  className={styles.wrapper}>
       ...
       <p className={styles.description}>
          ...
          знаходяться на вістрі науки та сучасних технологічних розробок.<br/>
           ...
           найважливіших питань його діяльності.<br/>
     ...
     <div className={styles.wrapper}>
       ...
       <p className={styles.description}>
         ...
         успішних викладацьких практик.<br/>
     ...
     <div  className={styles.wrapper}>
       ...
       <p className={styles.description}>
           ...
           Протягом 2019-2020 рр., команда розробників, до якої також вховходив 
           Сергій Міськів, розробили мобільну аплікацію  <a href="https://www.facebook.com/dzhuraapp/?__cft__%5B0%5D=AZXqmeXfO6rVnQJSRuy-J0Fj27Xu3f7QZMa5a4MsL9MZpNz9k7MoMxXTuBbehpT9srOHiJOQCzN4cxrIOY6Nv3v7I5NCMmUYKmf3bEieIUEyZrkk9l4imZ3KbZnE-SWdGVur6bkJDMMExCEII7mVx2u0s5hbIJNQikXghcc0baPNjKBeuez8MqF-YrmB3MiCEXo&__tn__=kK-R" className={styles.link}>Джура</a> для військовослужбовців 
           строкової служби.<br/>

           "Джура” виконує низку доволі простих, але корисних функцій:
            <ul>
              <li>
                таймер служби, який показує користувачу кількість часу до закінчення служби;
              </li>
              <li>
                спільний чат, який моніториться адмінами;
              </li>
              <li>
                новини пов’язані з Армією та дотичними сегментами Української держави;
              </li>
              <li>
           ...
           У проекті, Сергій Міськів виконував роль Team Leader на iOS стороні додатку. 
           Сергій створив першочергову архітектуру додатку та загальні правила написання 
           коду,  а також підтверджує всі pull requests та ініціативні зміни до кодової 
           бази від студентів.
           Значна частина роботи над додатком була виконана під час навчального курсу 
           “Розробка під iOS”, де до роботи над проектом були активно залучені наші 
           студенти: Євгеній Оренчук, Андрій Коваль, Олег Тижай, Олег Микитин та 
           Олександр Потапов.<br/>
         
         <a href="https://www.facebook.com/csatucu/posts/2565782233715532" className={styles.link}>Детальніше</a>
       </p>: null
      }
     </div>
     ...
     <div className={styles.imgWrapper}>
       ...
       <p className={styles.description}>
         ...
         і “Прогнозування та досілдження операцій”.<br/>
         Ярослав Любінець є співзасновником та головою ради директорів компанії
         SoftServe, разом із дружиною багато років підтримують наш університет. 
         Тарас Кицмей - співвласник і член ради директорів компанії SoftServe.
        </p>: null
      }
     </div>
