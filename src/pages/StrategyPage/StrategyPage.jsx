        ...
        <ul className={styles.list}>
          <li className={styles.item}>
            ...
            <span className={styles.text}>
              наші випускники є тими, хто творять нові робочі місця. Ми активно залучаємо студентів до викладення, науки
              та бізнес-проектів
            </span>
          </li>
          ...
          <li className={styles.item}>
            ...
            <span className={styles.text}>
              сформована alumni спільнота, яка продовжує навчання та формування випускників впродовж життя та залучає їх
              до різних освітніх ініціатив
            </span>
          </li>
          ...
          <li className={styles.item}>
            ...
            <span className={styles.text}>
              ...
              залучення зіркових викладачів. Ми піклуємось про наших працівників та створюємо комфортні умови онбордингу
              та праці
            </span>
          </li>
          ...
          <li className={styles.item}>
            ...
            <span className={styles.text}>
              ...
              через консалтинг, запровадження курсів суспільно-орієнтованого навчання та впровадження курсів "цифрового
              мислення" в світоглядне ядро та/чи загальноуніверситетські курси
            </span>
          </li>
        </ul>
      </section>
